...
public class Juego3 extends javax.swing.JFrame {
    ...
    JOptionPane.showMessageDialog(rootPane, btn.substring(0,1) + btn.substring(1,2));
    JOptionPane.showMessageDialog(rootPane, Integer.toString(grafo1.ind(f,c)));
       ...
       // Hay que hacerle una validacion antes
        for(int i=0; i<grafo1.listaady.length; i++){
            if(i==grafo1.ind(f,c)){
                ...
                // Muestra la casilla
                JOptionPane.showMessageDialog(null,"No hay mina");
                }else if(grafo1.listaady[i].Mine == false && grafo1.listaady[i].mineAdy==0){
                    JOptionPane.showMessageDialog(null,"No hay mina");
                //DFS o BFS
                }
